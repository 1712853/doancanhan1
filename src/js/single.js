...
function themeWhite()
{
    ...
    let aComment = document.querySelectorAll(".single__container_flexbox .single__left .comment__item_content ul li a");
    for (let i=0;i<aComment.length;i++)
    {
        aComment[i].addEventListener("mouseover",function(){aComment[i].style.color = "black"});
        aComment[i].addEventListener("mouseout",function(){aComment[i].style.color = "var(--main-color-1)"});
     
    }
    let aCategories = document.querySelectorAll(".single__container_flexbox .single__right .categories ul li a");
    for (let i=0;i<aCategories.length;i++)
    {
        aCategories[i].addEventListener("mouseover",function(){aCategories[i].style.color = "black"});
        aCategories[i].addEventListener("mouseout",function(){aCategories[i].style.color = "var(--grey1)"});
     
    }
    let aBlog1 = document.querySelectorAll(".single__container_flexbox .single__right .blog__container_item .link");
    styleColorArr(aBlog1,"#929292");
    let aBlog2 = document.querySelectorAll(".single__container_flexbox .single__right .blog__container_item .note a");
    for (let i=0;i<aBlog2.length;i++)
    {
        aBlog2[i].addEventListener("mouseover",function(){aBlog2[i].style.color = "black"});
        aBlog2[i].addEventListener("mouseout",function(){aBlog2[i].style.color = "var(--main-color-1)"});
...
function themeblack()
{
    ...
    for (let i=0;i<aComment.length;i++)
    {
        aComment[i].addEventListener("mouseover",function(){aComment[i].style.color = "white"});
        aComment[i].addEventListener("mouseout",function(){aComment[i].style.color = "var(--main-color-1)"});
    ...
    for (let i=0;i<aCategories.length;i++)
    {
        aCategories[i].addEventListener("mouseover",function(){aCategories[i].style.color = "white"});
        aCategories[i].addEventListener("mouseout",function(){aCategories[i].style.color = "var(--grey1)"});
    ...
    for (let i=0;i<aBlog2.length;i++)
    {
        aBlog2[i].addEventListener("mouseover",function(){aBlog2[i].style.color = "white"});
        aBlog2[i].addEventListener("mouseout",function(){aBlog2[i].style.color = "var(--main-color-1)"});
...
if (mode === "null") {localStorage.setItem(changeMode.className);
