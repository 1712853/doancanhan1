...
function themeWhite() {
  ...
  let pServices2 = document.querySelectorAll(
    ".services__container_flexbox .item div p"
  );
  ...
  aServices[0].addEventListener("mouseover", function () {
    aServices[0].style.color = "#9999a1";
  });
  aServices[0].addEventListener("mouseout", function () {
    aServices[0].style.color = "white";
  });

  styleColor(aServices[1], "#606167");
  aServices[1].addEventListener("mouseover", function () {
    aServices[1].style.color = "#9999a1";
  });
  aServices[1].addEventListener("mouseout", function () {
    aServices[1].style.color = "#606167";
  });
  ...
  let spanServices = document.querySelectorAll(
    ".services__container_flexbox .item span"
  );
...
function themeblack() {
  ...
  aServices[0].addEventListener("mouseout", function () {
    aServices[0].style.color = "black";
  });

  styleColor(aServices[1], "rgb(211, 117, 63)");
  aServices[1].addEventListener("mouseover", function () {
    aServices[1].style.color = "white";
  });
  aServices[1].addEventListener("mouseout", function () {
    aServices[1].style.color = "rgb(211, 117, 63)";
  });
...
function setValidateFormEvent() {
  ...
  signBtn.addEventListener("click", function () {
    ...
    if (!validateEmail(email)) alert("Vui lòng nhập đúng địng dạng email");
